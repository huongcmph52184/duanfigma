        ...
        <div class="admin">
            ...
            <nav>
                <ul id="dropdown">
                    ...
                    <li>
                        <a style="padding-left: 15px; width: 100%" style="font-size: 16px;" href="#"><i class="fa-solid fa-list"></i>Quản lý Danh mục<i class="fa-solid fa-angle-left left"></i></a>
                        <ul style="width: 100%;">
                    ...
                    <li>
                        <a href="#" style="padding-left: 15px; width: 100%; font-size: 16px"><i class="fa-solid fa-headphones"></i> Quản lý Sản phẩm <i class="fa-solid fa-angle-left left"></i></a>
                        <ul style="width: 100%;transition: 0.5s ease-out;">
                            ...
                            <li><a style="padding-left: 35px;" href="?act=listProductDetail"><i class="fa-solid fa-wand-magic-sparkles"></i> Danh sách sản phẩm biến thể</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="?act=listtk" style="padding-left: 15px; width: 100%; font-size: 16px"><i class="fa-solid fa-users"></i>Quản lý tài khoản</a>
                    </li>
                    <li>
                        <a href="" style="padding-left: 15px; width: 100%; font-size: 16px"><i class="fa-solid fa-comment"></i>Quản lý bình luận</a>
                    </li>
                    <li>
                        <a href="" style="padding-left: 15px; width: 100%; font-size: 16px"><i class="fa-solid fa-chart-simple"></i> Thống kê</a>
                    </li>
                    <li>
                        <a href="" style="padding-left: 15px; width: 100%; font-size: 16px"> <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-cart-check-fill" viewBox="0 0 16 16">
