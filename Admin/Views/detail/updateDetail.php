                ...
                <form action="?act=postupdateDetail&id=<?= $detail['id_sp_chitiet'] ?>" method="POST" enctype="multipart/form-data">
                    <div class="select">
                        <div class="select_one">
                            <label for=""  style="margin-left: 5px; display: flex; margin-bottom: 0px;">Sản phẩm <p style="color: red; margin-left: 5px;">(*)</p></label>
                            ...
                            <label for=""  style="margin-left: 5px; display: flex; margin-top: 10px; margin-bottom: 0px;">Giá Sản phẩm <p style="color: red; margin-left: 5px;">(*)</p></label>
                            <select name="id_price" class="form-select" aria-label="Default select example">
                        ...
                        <div class="select_two">
                            <label for="" style="margin-left: 5px; display: flex; margin-bottom: 0px;">Chọn màu sản phẩm <p style="color: red; margin-left: 5px;">(*)</p></label>
                            <select name="id_mau" class="form-select" aria-label="Default select example">
                            ...
                            <label for="" style="margin-left: 5px; display: flex; margin-top: 10px; margin-bottom: 0px;">Chọn dung lương sản phẩm <p style="color: red; margin-left: 5px;">(*)</p></label>
                    ...
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label" style="margin-left: 5px; display: flex;">Chọn ảnh sản phẩm <p style="color: red; margin-left: 5px;">(*)</p></label>
                        <input type="file" class="form-control" id="exampleInputPassword1" name="image">
                        <img src="<?= $detail['image_url'] ?>" width="80" alt="">
                    </div>
                    <div class="mb-3" style="margin-top: 20px;">
                        <label for="exampleInputEmail1" class="form-label" style="margin-left: 5px; display: flex;">Nhập số lượng hàng <p style="color: red; margin-left: 5px;">(*)</p></label>
