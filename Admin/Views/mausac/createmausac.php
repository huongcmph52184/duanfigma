    ...
    <section class="Danhmuc">
        ...
        <section class="contenDanhmuc">
            ...
            <div class="button" style="display: flex; margin-bottom: 30px;">
                ...
                <a style="margin-top: 20px; margin-left: 710px;" href="?act=listmausac"><button type="button" class="btn btn-success"><i class="fa-solid fa-list"></i> Danh sách</button></a>
            </div>
            <article>
                <?php
                ...
                ?>
                <form action="?act=postcreateMausanpham" method="POST" enctype="multipart/form-data">
                    <label class="form-label"  style="margin-left: 5px; display: flex; margin-bottom: 0px" for="">Sản phẩm <p style="color: red; margin-left: 5px;">(*)</p></label>
                    ...
                    <div class="mb-3" style="margin-top: 20px;">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="tenmau">
                    </div>
                    <div class="mb-3">
